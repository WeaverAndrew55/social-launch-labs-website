          ...
          <div>
            ...
            <ul className="grid grid-cols-1 gap-4 py-2">
              <li className="flex self-start">
                ...
                <p>🎬 Brand Story Video – Elevate your brand's narrative.</p>
              </li>
              <li className="flex self-start">
                <div className="mr-4 flex-none self-start">
                  <img
                ...
                <p>🏆 Customer Success Story – Showcase real-world impact.</p>
              </li>
              <li className="flex self-start">
                <div className="mr-4 flex-none self-start">
                  <img
                ...
                <p>
                  🎓 Thought Leadership Video – Establish expertise and
                  credibility.
                </p>
              </li>
            </ul>
