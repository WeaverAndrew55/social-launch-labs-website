                      ...
                      <div className="grid auto-rows-max grid-cols-1 grid-rows-[max-content] gap-y-2 md:gap-y-4">
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            ...
                            <p className="hidden text-sm md:block">
                              Discover how we help you capture leads.
                            </p>
                          </div>
                        </a>
                        <a
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            ...
                            <p className="hidden text-sm md:block">
                              Increase your sales with our video strategies.
                            </p>
                          </div>
                        </a>
                        <a
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            <h5 className="font-semibold">Authority Builder</h5>
                            <p className="hidden text-sm md:block">
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            ...
                            <p className="hidden text-sm md:block">
                              White-label video solutions for marketing
                              agencies.
                            </p>
                          </div>
                        </a>
                      ...
                      <div className="grid auto-rows-max grid-cols-1 grid-rows-[max-content] gap-y-2 md:gap-y-4">
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            ...
                            <p className="hidden text-sm md:block">
                              Read our latest insights on video marketing.
                            </p>
                          </div>
                        </a>
                        <a
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            <h5 className="font-semibold">Client Success</h5>
                            <p className="hidden text-sm md:block">
                        ...
                        >
                          ...
                          <div className="flex flex-col items-start justify-center">
                            ...
                            <p className="hidden text-sm md:block">
                              Stay updated with our newest blog posts.
                            </p>
                          </div>
                        </a>
                      </div>
                        ...
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[auto_auto] items-start gap-y-2 lg:grid-rows-[auto]">
                          ...
                          >
                            ...
                            <div className="rt-4 mt-4 flex flex-col justify-start md:mt-0">
                              ...
                              <p className="text-sm">
                                Strategies to enhance your video presence.
                              </p>
                          ...
                          >
                            ...
                            <div className="rt-4 mt-4 flex flex-col justify-start md:mt-0">
                              ...
                              <p className="text-sm">
                                How to create engaging content for your brand.
                              </p>
                              <div className="mt-1.5">
                                <Button
                                  title="Read more"
