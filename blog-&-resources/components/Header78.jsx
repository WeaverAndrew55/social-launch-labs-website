      ...
      <div className="container flex flex-col items-center">
        <div className="rb-12 mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          <h1 className="mb-5 text-6xl font-bold md:mb-6 md:text-9xl lg:text-10xl">
            Expert Insights on Video Marketing & Business Growth
          </h1>
          <p className="md:text-md">
            Stay ahead with strategic guides, industry trends, and expert advice
            from Social Launch Labs. Our resources are designed to empower your
            business growth through effective video marketing.
          </p>
