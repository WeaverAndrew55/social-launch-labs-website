    ...
    >
      <div className="mx-[5%] sm:max-w-md md:justify-self-start lg:ml-[5vw] lg:mr-20 lg:justify-self-end">
        ...
        <p className="md:text-md">
          Leverage professional video content to position yourself as a trusted
          authority in your field. Build credibility and trust with your
          audience through impactful storytelling.
        </p>
        <div className="mt-6 flex flex-wrap gap-x-4 gap-y-4 md:mt-8">
          <Button title="Start Building Authority">
